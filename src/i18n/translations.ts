...
export const translations = {
  he: {
    ...
    'family.alertSafeShared': 'סטטוס הבטיחות שלך עודכן בקבוצה המקומית.',
    'family.you': 'אתה',
  ...
  en: {
    ...
    'family.inviteSubtitle': 'Share the code or link so someone else can join this local safety circle.',
  ...
  ar: {
    ...
    'family.inviteSubtitle': 'شارك الرمز أو الرابط حتى يتمكن شخص آخر من الانضمام إلى دائرة الأمان المحلية هذه.',
    ...
    'family.alertSafeShared': 'تمت مشاركة حالة سلامتك مع مجموعة العائلة المحلية.',
    'family.you': 'أنت',
  ...
  ru: {
    ...
    'family.inviteSubtitle': 'Поделитесь кодом или ссылкой, чтобы кто-то еще мог присоединиться к этому локальному кругу безопасности.',
    ...
    'family.alertSafeShared': 'Ваш статус безопасности обновлён в локальной семейной группе.',
    'family.you': 'Вы',
